...
const Service = () => {
  return (
    <div className='bg-[#020617] dark:bg-[#fefce8] text-white py-20' id='services'>
                ...
                {services.map(service =>(
                    <div key={service.id}
                     className='bg-gray-800 dark:bg-gradient-to-r from-red-400 to-yellow-500 px-6 pb-6 rounded-lg hover:shadow-lg transform transition-transform duration-300 hover:scale-105'>
                        <div className='text-right text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-yellow-400 dark:text-[#1e1b4b]'>
                            {service.id}
                        </div>
