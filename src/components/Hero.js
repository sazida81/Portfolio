...
<div className='bg-[#020617] dark:bg-[#fefce8] text-white text-center py-16'>
      ...
      <div className='mt-8 space-x-4'>
        <button className='bg-gradient-to-r from-red-500 to-yellow-400 text-white hidden
         md:inline transform transition-transform duration-300 hover:scale-105 px-4 py-2 rounded-full dark:text-black font-semibold'><a href='#footer'>Connect with me</a></button>
        <button className='bg-gradient-to-r from-yellow-500 to-black-400 text-white hidden
         md:inline transform transition-transform duration-300 hover:scale-105 px-4 py-2 rounded-full dark:text-black font-semibold'>
