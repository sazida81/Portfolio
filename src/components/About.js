...
const About = () => {
  return (
    <div className='bg-[#020617] dark:bg-[#fefce8] font-medium text-white py-20' id='about'>
        ...
        <div className='container mx-auto px-8 md:px-16 lg:px-24'>
            ...
            <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                ...
                <p className='text-md mb-8 dark:text-[#1e1b4b]'>
                ...
                <div className='space-y-4'>
                    ...
                    <div className='flex items-center'>
                        <label htmlFor='htmlandcss' className='w-2/12 mr-8 dark:text-[#1e1b4b] font-bold'>HTML & CSS</label>
                    ...
                    <div className='flex items-center'>
                        <label htmlFor='htmlandcss' className='w-2/12 mr-8 dark:text-[#1e1b4b] font-bold'>Javascript</label>
                        <div className='grow bg-gray-800 rounded-full h-2.5'>
                        <div className='bg-gradient-to-r from-red-400 to-yellow-500 h-2.5 rounded-full transform transition-transform duration-300 hover:scale-105 w-12/12'> </div>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center'>
                        <label htmlFor='htmlandcss' className='w-2/12 mr-8 dark:text-[#1e1b4b] font-bold'>React js</label>
                        <div className='grow bg-gray-800 rounded-full h-2.5'>
                    ...
                    <div className='flex items-center'>
                        <label htmlFor='htmlandcss' className='w-2/12 mr-8 dark:text-[#1e1b4b] font-bold'>Java</label>
                        <div className='grow bg-gray-800 rounded-full h-2.5'>
                    ...
                    <div className='flex items-center'>
                        <label htmlFor='htmlandcss' className='w-2/12 mr-8 dark:text-[#1e1b4b] font-bold'>Python</label>
                        <div className='grow bg-gray-800 rounded-full h-2.5'>
                ...
                <div className='mt-12 flex justify-between text-center'>
                  <div>
                    ...
                    <p className='dark:text-[#1e1b4b]'>Years Experience</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className='dark:text-[#1e1b4b]' >Projects Completed</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className='dark:text-[#1e1b4b]'>Happy Clients</p>
                  </div>
